...
if(result==true){
    <?
        ...
        $query_file= "select * from qna where no='$no' and user_id='$member[user_id]'";
        ...
        $comment_query = "delete from qna_comment where bbs1_no = '$no' ";
        mysqli_query($connect, $comment_query);


        $query="delete from qna where no='$no' and user_id='$member[user_id]'";
