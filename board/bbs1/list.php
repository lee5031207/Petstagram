...
?>
<h2 style="font-family: 'Do Hyeon', sans-serif;">Hot 게시판</h2>
 <table class="table table-borde#A4A4A4 table-hover">
            <!-- <tr>
                <th style="text-align:center; width:7%; background-color:white;"></th>
                <th style="text-align:center; width:16%; background-color:white;"></th>
                <th style="text-align:center; width:40%; background-color:white; font-family: 'Do Hyeon', sans-serif;">HOT 게시판</th>
                <th style="text-align:center; width:20%; background-color:white;"></th>
                <th style="text-align:center; width:7%; background-color:white;"></th>
            </tr> -->
            <tr>
...
?>
<h2 style="font-family: 'Do Hyeon', sans-serif;">자유 게시판</h2>
        <table class="table table-borde#A4A4A4 table-hover">
            <!-- <tr>
